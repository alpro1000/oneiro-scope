...
**Дата последнего обновления:** 2026-07-27 (part 3 — геокодер)
**Последняя ветка работы:** `claude/identity-direction-question-vrognh` (PR #163)
**Текущий main HEAD:** `#162` — коннектор живой, закрыт OAuth, карта считается через чат
