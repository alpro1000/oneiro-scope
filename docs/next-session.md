...
- DreamBank-корпус Dryad (doi:10.5061/dryad.qbzkh18fr) — скачать локально,
  прогнать через golden-harness как внешнюю валидацию (микро-P/R путь тот
  же).
- Калибровка недобора по категориям (после каппы/корпуса) — снять
  систематическое «пользователь спокойнее нормы»; до неё честность несёт
  `method_note` в norm_comparison.
