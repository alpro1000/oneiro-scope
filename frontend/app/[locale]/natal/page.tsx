...
// ── demo chart (Swiss Ephemeris, 1977-07-01 19:30 UTC) ──────────────────────
// Real numbers, works offline; replaced wholesale by POST /api/v1/chart. The
// page never computes an ephemeris — this is only a seed so the wheel is not
// empty before a fetch.
const DEMO_CORE: ChartCore = {
